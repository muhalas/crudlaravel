...
<head>
  ...
  {{-- Datepicker --}}
  <link rel="stylesheet" href="{{ asset('air-datepicker/air-datepicker.css') }}">
  {{-- Chart JS --}}
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/chartDataTable" class="nav-link active">
              <i class="nav-icon fas fa-tachometer-alt"></i>Dashboard</a>
          </li>

          <li class="nav-item">
            <a href="/arankas" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>Arankas</a>
          </li>
          
          <li class="nav-item">
            <a href="/chartDataTable" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>Charts</a>
          </li>
        </ul>
      </nav>
      <!-- /.sidebar-menu -->
...
{{-- Datepicker --}}
<script src="{{ asset('air-datepicker/air-datepicker.js') }}"></script>
<!-- REQUIRED SCRIPTS -->
<!-- jQuery -->
